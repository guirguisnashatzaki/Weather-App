...
import 'package:weatherapp/services/weather_service.dart' as _i4;
...
class MockWeatherService extends _i1.Mock implements _i4.WeatherService {
  ...
  @override
  _i6.Future<_i2.Weather> getWeather(String? cityName) => (super.noSuchMethod(
        Invocation.method(
          #getWeather,
          [cityName],
        ),
  ...
  @override
  _i6.Future<String> getCurrentCity() => (super.noSuchMethod(
        Invocation.method(
          #getCurrentCity,
          [],
        ),
